 ...
 * @type {Object}
 */
var FEED_CONTROL_SEQUENCES = map[string][]byte{
...
var CHARACTER_SPACING = map[string][]byte{
	"CS_DEFAULT": {0x1b, 0x20, 0x00},
	"CS_SET":     {0x1b, 0x20},
}

var LINE_SPACING = map[string][]byte{
 ...
 * @type {Object}
 */
var CASH_DRAWER = map[string][]byte{
 ...
 * @type {Object}
 */
var TEXT_FORMAT = map[string][]byte{
	...
	"TXT_ITALIC_OFF": {0x1b, 0x35},       // Italic font OFF
...
var BARCODE_FORMAT = map[string][]byte{
 ...
 * @type {Object}
 */
var IMAGE_FORMAT = map[string][]byte{
 ...
 * @type {Object}
 */
var BITMAP_FORMAT = map[string][]byte{
 ...
 * @type {Object}
 */
var GSV0_FORMAT = map[string][]byte{
 ...
 * @type {string}
 */
var BEEP = []byte{0x1b, 0x42} // Printer Buzzer pre hex
...
var COLOR = map[string][]byte{
	...
	"2": {0x1b, 0x72, 0x02}, // green
	"3": {0x1b, 0x72, 0x03}, // yellow
	"4": {0x1b, 0x72, 0x04}, // blue
	"5": {0x1b, 0x72, 0x05}, // magenta
	"6": {0x1b, 0x72, 0x06}, // cyan
}
